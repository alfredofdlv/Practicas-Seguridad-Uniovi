from CreTxt import hasheo_password
...
def autentica_usuario(usuario, contraseña):
    try:
        with open(r"D:\clase\Practicas-Seguridad-Uniovi\Criptografia\Autenticacion\usuarios.txt", mode="r") as f:
            for linea in f:
...
def main():
    ...
    autentica_usuario(usuario,contraseña)
