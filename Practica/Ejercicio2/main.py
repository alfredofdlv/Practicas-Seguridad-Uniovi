...
def main():
    ...
    hash_oficial = "b18f4343715cf8df8e86feee32a79fe64c6db6114d1783d694239ec979cca638"
    ...
    if hash_calculado==hash_oficial: 
        print('Parche completo',''.join([segmento_1.decode(),segmento_2.decode(),segmento_3.decode()]))

        priv_A,pub_A=generar_claves
        priv_B,pub_B=generar_claves
        priv_C,pub_C=generar_claves


        import Hibrido

        Hibrido.enviar_mensaje("B","B",priv_A)
    else: 
